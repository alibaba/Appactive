...
public class ConcurrentHashSet<E> extends AbstractSet<E> implements Set<E>,Serializable {
    ...
    private static final long serialVersionUID = -2714803622174111108L;
    ...
    public ConcurrentHashSet(Collection<? extends E> var1) {
        this.map = new ConcurrentHashMap<E, Object>(Math.max((int)((float)var1.size() / 0.75F) + 1, 16));
        this.addAll(var1);
    }
    ...
    /**
     * Removes the specified element to this set if it is present. More
     ...
     *
     * @param o
     *            object to be removed to this set, if present
    ...
    /**
     * Removes all of the elements to this set. The set will be empty after
     * this call returns.
     */
    @Override
    public void clear() {
